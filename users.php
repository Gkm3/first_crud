    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <?php if(is_admin()): ?>
                    <a class="btn btn-success" href="create_user.php"><?php echo "Добавить"; ?></a>
                    <?php endif; ?>
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_<?php echo $user['id']; ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo mb_strtolower($user['username']); ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user['status']; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo !has_image($user['id']) ? "img/demo/authors/josh.png" : "upload/".$user["image"]; ?>'); background-size: cover;"></span>
                                </span>
                                ...
                                <a href="./page_profile.php?id=<?php echo $user['id']; ?>">
                                    ...
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php if(show_dropdown_menu($user)): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="handlers/handler_deleter.php?id=<?php echo $user['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
